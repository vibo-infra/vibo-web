...
const SearchEventComponent = () => {
  return (
    <div className='flex flex-col gap-4 bg-background-primary-light shadow-medium p-4 rounded-md'>
      ...
      <Button variant="primary" className="mt-2 text-text font-bold shadow-medium hover:shadow-soft" style={{borderRadius: '10px'}}>Find Events</Button>
    </div>
  )
}
